...
import com.example.ohmytaxi.db.UsuariosSQLiteHelper;
/*http://www.sgoliver.net/blog/?p=1646
 * En toda esta clase tenemos métodos para guardar las rutas en la base de datos, que pongo aquí para que nos sirva de guia: 
 * en la clase que muestra el mapa, pondremos un botón para GUARDAR RUTA
*/
public class UsuariosMainActivity extends Activity{
